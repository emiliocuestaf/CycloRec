...
#from recommenders.rec_algorithms import random_rec, most_popular_rec, most_valuable_rec, user_based_knn_rec, item_based_knn_rec, matrix_factorization_rec

class UserMABRecommender(BaseRecommender):
    """
    ...
    def __init__(self, dataLayer, mab_policy, epsilon=0.2, delta=2, alphas=1, betas=1):
        ...
        super().__init__(recommenderName='user_MAB', dataLayer=dataLayer)  
    ...
    def select_item(self, userLayer, enable_repetitions=False):
        ...
        eligible_items = userLayer.get_available_items_idxs(enable_repetitions)
