...
class ItemMABRecommender(BaseRecommender):
    """
    ...
    def __init__(self, dataLayer, mab_policy, epsilon=0.2, delta=2, alphas=1, betas=1):
        ...
        super().__init__(recommenderName='item_MAB', dataLayer=dataLayer)  
    ...
    def train(self):
        ...
        for (_, _, item_idx, rating) in traindf.itertuples():
            ...
            self.mab.update_rewards(item_idx, reward=rating)  
        return 
    ...
    def rating_update(self, user_idx, item_idx, rating):
        ...
        self.mab.update_rewards(item_idx, reward)
        return 
