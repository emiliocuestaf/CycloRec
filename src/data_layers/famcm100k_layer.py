...
class FamCm100kLayer(DataLayer):
    """ DataLayer designed to automatize the work with the Cm100K dataset. A random partition is performed.
        This datalayers only works with familiar ratings, those which 'known' value is 1.
    """
    ...
    def __init__(self, name, test_proportion):
        ...
        ratings = ratings[ratings['known'] == 1]
